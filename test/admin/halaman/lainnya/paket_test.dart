...
void main() {
  ...
  final paketList = [
    PaketModel(
        id: '1', nama: 'Paket A', harga: 10000, durasi: 1, tipe: TipeDurasiPaket.days, poinHadiah: 10),
    PaketModel(
        id: '2', nama: 'Paket B', harga: 20000, durasi: 7, tipe: TipeDurasiPaket.days, poinHadiah: 20),
  ];
  ...
  group('PackagePage Tests', () {
    ...
    testWidgets('02. should open add package form', (tester) async {
      ...
      expect(find.text('Tambah Paket'), findsNothing); // New page
    });
    ...
    testWidgets('04. should show delete all confirmation dialog', (tester) async {
      await tester.pumpWidget(createWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('06. should show edit/delete dialog on long press', (tester) async {
      await tester.pumpWidget(createWidget());
      await tester.pumpAndSettle();
