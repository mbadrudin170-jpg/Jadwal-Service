...
void main() {
  ...
  final dompetAwal =
      DompetModel(id: 'd1', nama: 'Dompet Utama', saldo: 1000.0);
  ...
  setUp(() {
    ...
    when(() => mockTransaksiOpSqlite.softDelete(any()))
  ...
  group('01. DetailDompet Widget Tests', () {
    ...
    testWidgets(
      ...
      final completer = Completer<DetailDompetData>();
      ...
      await tester.pumpWidget(
        ProviderScope(
          ...
          child: MaterialApp(
            home: FutureBuilder<DetailDompetData>(
  ...
  group('02. Interaksi dan Navigasi', () {
    ...
    testWidgets(
      ...
      final route =
          MaterialPageRoute(builder: (_) => const Scaffold(body: Text('Tujuan')));
      when(() => mockNavigatorObserver.didPush(any(), any())).thenAnswer((_) {
        // Langsung pop dengan nilai true saat push terdeteksi
      ...
      // Atau, cara yang lebih eksplisit
      // await tester.page.navigator.push(route);
      // await tester.page.navigator.pop(true);
    ...
    testWidgets('03. harus hapus transaksi dan refresh data saat on_delete ditekan',
        (tester) async {
      when(() => mockDompetOpSqlite.ambilBerdasarkanId('d1'))
          .thenAnswer((_) async => dompetAwal);
      when(() => mockTransaksiOpSqlite.getTransactionsByWalletId('d1'))
    ...
    testWidgets('04. harus navigasi ke FormTransaksi saat onEdit ditekan', (tester) async {
      await tester.pumpWidget(createWidget());
      await tester.pumpAndSettle();
      ...
      final pushedRoute = verify(() => mockNavigatorObserver.didPush(captureAny(), any())).captured.last as MaterialPageRoute;
