  ...
  group('LayananAktivitasUser', () {
    test(
      ...
      () async {
        ...
        when(
          mockPelangganOpFirebase.perbaruiTerakhirAktif(any),
        ).thenAnswer((_) async {});
        ...
        verify(
          mockPrefs.setInt(LayananAktivitasUser.kunciPingTerakhirAktif, any),
        ).called(1);
      },
    );
    ...
    test(
      ...
      () async {
        ...
        await layananAktivitasUser.pingAktivitas(userId, paksa: true);
    ...
    test(
      ...
      () async {
        ...
        final timestamp = now
            .subtract(
              LayananAktivitasUser.jadwalPing - const Duration(minutes: 1),
            )
