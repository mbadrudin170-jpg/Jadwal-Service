...
class MockLayananPenyimpananLokal extends _i1.Mock
  ...
  @override
  _i4.Future<void> simpanModeTema(_i5.ThemeMode? mode) => (super.noSuchMethod(
        Invocation.method(
          #simpanModeTema,
          [mode],
        ),
  ...
  @override
  _i4.Future<_i5.ThemeMode> ambilModeTema() => (super.noSuchMethod(
        Invocation.method(
          #ambilModeTema,
          [],
        ),
  ...
  @override
  _i4.Future<void> hapusAkunSaatIni() => (super.noSuchMethod(
        Invocation.method(
          #hapusAkunSaatIni,
          [],
        ),
  ...
  @override
  _i4.Future<void> hapusTokenLogin() => (super.noSuchMethod(
        Invocation.method(
          #hapusTokenLogin,
          [],
        ),
