...
void main() {
  ...
  group('ambilPengaturan', () {
    test(
        '01. harus mengembalikan data pengaturan jika dokumen ada',
        () async {
      // Arrange
      final data = {
    ...
    test(
        '03. harus mengembalikan data default jika terjadi error',
        () async {
      // Arrange
      final brokenFirestore = _BrokenFirebaseFirestore();
...
// Helper class to simulate Firestore errors
class _BrokenFirebaseFirestore extends Mock implements FirebaseFirestore {
  @override
