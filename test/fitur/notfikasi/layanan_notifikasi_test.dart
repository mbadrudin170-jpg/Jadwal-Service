...
void main() {
  ...
  const MethodChannel timezoneChannel =
      MethodChannel('plugins.flutter.io/flutter_timezone');
  ...
  group('Inisialisasi', () {
    test('01. harus menginisialisasi plugin dan channel dengan benar',
        () async {
      ...
      final captured = verify(mockPlugin.initialize(
        settings: captureAnyNamed('settings'),
        onDidReceiveNotificationResponse:
            captureAnyNamed('onDidReceiveNotificationResponse'),
        onDidReceiveBackgroundNotificationResponse:
            captureAnyNamed('onDidReceiveBackgroundNotificationResponse'),
      )).captured;
    ...
    test('02. _inisialisasiZonaWaktu menangani zona waktu GMT sebagai fallback',
        () async {
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(timezoneChannel,
              (MethodCall methodCall) async {
  ...
  group('Operasi Notifikasi', () {
    ...
    test('06. batalNotifikasi harus memanggil plugin.cancel dengan ID',
        () async {
      const id = 789;
      when(mockPlugin.cancel(id: anyNamed('id'))).thenAnswer((_) async {});
  ...
  group('Pemantauan Notifikasi', () {
    ...
    test(
      ...
      when(mockNotifikasiOp.getByUserId('user1'))
    ...
    test('10. hentikanPemantauanNotifikasi harus menutup subscription',
        () async {
