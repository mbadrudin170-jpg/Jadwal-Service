...
void main() {
  ...
  group('UpdateApkPage', () {
    testWidgets('Test 01: should display version information', (WidgetTester tester) async {
    ...
    testWidgets('Test 02: should display changelog', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
    ...
    testWidgets('Test 03: should show download button', (WidgetTester tester) async {
      await tester.pumpWidget(createWidgetUnderTest());
