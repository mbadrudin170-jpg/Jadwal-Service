...
// in wifi/test/shared/data/sync/unduhan_awal_test.dart.
...
import 'package:wifi/shared/data/sync/download%20data.dart' as _i6;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockLayananUnduhData extends _i1.Mock implements _i6.LayananUnduhData {
  MockLayananUnduhData() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<void> unduhSemuaData() => (super.noSuchMethod(
        Invocation.method(
          #unduhSemuaData,
          [],
        ),
  ...
  @override
  _i3.Future<void> unduhDataPengaturan() => (super.noSuchMethod(
        Invocation.method(
          #unduhDataPengaturan,
          [],
        ),
  ...
  @override
  _i3.Future<void> unduhDataDompet() => (super.noSuchMethod(
        Invocation.method(
          #unduhDataDompet,
          [],
        ),
  ...
  @override
  _i3.Future<void> unduhDataKategori() => (super.noSuchMethod(
        Invocation.method(
          #unduhDataKategori,
          [],
        ),
  ...
  @override
  _i3.Future<void> unduhDataPaket() => (super.noSuchMethod(
        Invocation.method(
          #unduhDataPaket,
          [],
        ),
  ...
  @override
  _i3.Future<void> unduhDataPelanggan() => (super.noSuchMethod(
        Invocation.method(
          #unduhDataPelanggan,
          [],
        ),
  ...
  @override
  _i3.Future<void> unduhDataPelangganAktif() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> unduhDataTransaksi() => (super.noSuchMethod(
        Invocation.method(
          #unduhDataTransaksi,
          [],
        ),
  ...
  @override
  _i3.Future<void> unduhDataKritikSaran() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> unduhDataPesanan() => (super.noSuchMethod(
        Invocation.method(
          #unduhDataPesanan,
          [],
        ),
  ...
  @override
  _i3.Future<void> unduhDataSubKategori() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> unduhDataVersiApkUser() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i3.Future<void> sinkronisasiKoleksi<T>({
    ...
    required _i3.Future<void> Function(List<T>)? operasiBatch,
  }) =>
      (super.noSuchMethod(
        Invocation.method(
          #sinkronisasiKoleksi,
          [],
          {
            ...
            #waktuUnduhTerakhir: waktuUnduhTerakhir,
