...
void main() {
  group('BaseOpFirebase', () {
    ...
    test('01. tambah - harus menambahkan dokumen dan memperbarui status', () async {
    ...
    test('02. sisipkan - harus menyisipkan dokumen dan memperbarui status', () async {
    ...
    test('03. update - harus memperbarui dokumen dan memperbarui status', () async {
    ...
    test('04. hapusSementara - harus melakukan soft delete dan memperbarui status', () async {
      await fakeFirestore.collection(collectionName).doc(docId).set(data);
    ...
    test('05. hapusPermanen - harus menghapus dokumen dan memperbarui status', () async {
      await fakeFirestore.collection(collectionName).doc(docId).set(data);
    ...
    test('06. hapusSementaraSemua - harus melakukan soft delete pada semua dokumen', () async {
      await fakeFirestore.collection(collectionName).doc('doc1').set({'nama': 'doc1', NamaKolom.dihapus: false});
      await fakeFirestore.collection(collectionName).doc('doc2').set({'nama': 'doc2', NamaKolom.dihapus: false});
    ...
    test('07. insertOrUpdateBatch - harus menyisipkan atau memperbarui batch', () async {
      final items = [
        {'id': 'doc1', 'nama': 'Doc 1'},
        {'id': 'doc2', 'nama': 'Doc 2'},
