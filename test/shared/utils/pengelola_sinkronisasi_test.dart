  ...
  group('PengelolaSinkronisasi', () {
    ...
    test(
      ...
      () async {
        ...
        final result = await pengelolaSinkronisasi
    ...
    test(
      ...
      () async {
        ...
        final retrievedTime = await pengelolaSinkronisasi
            .ambilWaktuTerakhirUnduhPreferensi();
        expect(
          retrievedTime.toUtc().millisecondsSinceEpoch,
    ...
    test(
      ...
      () async {
        ...
        var retrievedUnduh = await pengelolaSinkronisasi
            .ambilWaktuTerakhirUnduhPreferensi();
        var retrievedUnggah = await pengelolaSinkronisasi
        ...
        final defaultTime = DateTime.fromMillisecondsSinceEpoch(0, isUtc: true);
        retrievedUnduh = await pengelolaSinkronisasi
            .ambilWaktuTerakhirUnduhPreferensi();
        retrievedUnggah = await pengelolaSinkronisasi
            .ambilWaktuTerakhirUnggahPreferensi();
