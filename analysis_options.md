...
#     # GAYA KODE (STYLE)
#     # ============================================================
#     sort_pub_dependencies: false              # Urutkan dependencies di pubspec.yaml secara alfabetis agar mudah dibaca
...
#     # ============================================================
#     avoid_catches_without_on_clauses: false   # Hindari catch tanpa klausa 'on', cegah menangkap Error yang seharusnya crash
...
#     prefer_final_parameters: false               # Gunakan final untuk parameter yang tidak di-reassign
...
# # /home/user/myapp/analysis_options.yaml
...
#   #   use_null_aware_elements: warning
...
#   #   unnecessary_null_checks: warning
  ...
  language:
    strict-casts: true              # Casting harus eksplisit dan aman
    strict-inference: true          # Tipe tidak boleh di-infer sebagai dynamic
    strict-raw-types: true          # Generik harus diberi parameter tipe (tidak boleh mentah)