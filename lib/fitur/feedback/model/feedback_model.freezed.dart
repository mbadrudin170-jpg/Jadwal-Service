...
mixin _$FeedbackModel {
 ...
 String get id; String get pesan; DateTime? get tanggal; String get userId; DateTime? get diperbaruiPada; bool get dihapus; DateTime? get diarsipkanPada;
...
@override
int get hashCode => Object.hash(runtimeType,id,pesan,tanggal,userId,diperbaruiPada,dihapus,diarsipkanPada);
...
@useResult
$Res call({
 String id, String pesan, DateTime? tanggal, String userId, DateTime? diperbaruiPada, bool dihapus, DateTime? diarsipkanPada
});
...
/// Create a copy of FeedbackModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? pesan = null,Object? tanggal = freezed,Object? userId = null,Object? diperbaruiPada = freezed,Object? dihapus = null,Object? diarsipkanPada = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String pesan,  DateTime? tanggal,  String userId,  DateTime? diperbaruiPada,  bool dihapus,  DateTime? diarsipkanPada)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _FeedbackModel() when $default != null:
return $default(_that.id,_that.pesan,_that.tanggal,_that.userId,_that.diperbaruiPada,_that.dihapus,_that.diarsipkanPada);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String pesan,  DateTime? tanggal,  String userId,  DateTime? diperbaruiPada,  bool dihapus,  DateTime? diarsipkanPada)  $default,) {final _that = this;
switch (_that) {
case _FeedbackModel():
return $default(_that.id,_that.pesan,_that.tanggal,_that.userId,_that.diperbaruiPada,_that.dihapus,_that.diarsipkanPada);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String pesan,  DateTime? tanggal,  String userId,  DateTime? diperbaruiPada,  bool dihapus,  DateTime? diarsipkanPada)?  $default,) {final _that = this;
switch (_that) {
case _FeedbackModel() when $default != null:
return $default(_that.id,_that.pesan,_that.tanggal,_that.userId,_that.diperbaruiPada,_that.dihapus,_that.diarsipkanPada);case _:
  return null;
...
class _FeedbackModel extends FeedbackModel {
  const _FeedbackModel({required this.id, required this.pesan, this.tanggal, required this.userId, this.diperbaruiPada, this.dihapus = false, this.diarsipkanPada}): super._();
...
/// Create a copy of FeedbackModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? pesan = null,Object? tanggal = freezed,Object? userId = null,Object? diperbaruiPada = freezed,Object? dihapus = null,Object? diarsipkanPada = freezed,}) {
