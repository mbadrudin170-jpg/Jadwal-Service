...
mixin _$DompetModel {
  ...
  $DompetModelCopyWith<DompetModel> get copyWith =>
      _$DompetModelCopyWithImpl<DompetModel>(this as DompetModel, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is DompetModel &&
...
abstract mixin class $DompetModelCopyWith<$Res> {
  factory $DompetModelCopyWith(
          DompetModel value, $Res Function(DompetModel) _then) =
      _$DompetModelCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String nama,
...
/// @nodoc
class _$DompetModelCopyWithImpl<$Res> implements $DompetModelCopyWith<$Res> {
...
extension DompetModelPatterns on DompetModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DompetModel value)? $default, {
...
class _DompetModel extends DompetModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DompetModelCopyWith<_DompetModel> get copyWith =>
      __$DompetModelCopyWithImpl<_DompetModel>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _DompetModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.nama, nama) || other.nama == nama) &&
            (identical(other.saldo, saldo) || other.saldo == saldo) &&
            (identical(other.diperbaruiPada, diperbaruiPada) ||
...
/// @nodoc
abstract mixin class _$DompetModelCopyWith<$Res>
    implements $DompetModelCopyWith<$Res> {
  factory _$DompetModelCopyWith(
          _DompetModel value, $Res Function(_DompetModel) _then) =
      __$DompetModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$DompetModelCopyWithImpl<$Res> implements _$DompetModelCopyWith<$Res> {
