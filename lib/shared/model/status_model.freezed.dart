...
mixin _$StatusModel {
 ...
 String get id; DateTime? get diperbaruiPada;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is StatusModel&&(identical(other.id, id) || other.id == id)&&(identical(other.diperbaruiPada, diperbaruiPada) || other.diperbaruiPada == diperbaruiPada));
}
...
@useResult
$Res call({
 String id, DateTime? diperbaruiPada
});
...
/// Create a copy of StatusModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? diperbaruiPada = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime? diperbaruiPada)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StatusModel() when $default != null:
return $default(_that.id,_that.diperbaruiPada);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime? diperbaruiPada)  $default,) {final _that = this;
switch (_that) {
case _StatusModel():
return $default(_that.id,_that.diperbaruiPada);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime? diperbaruiPada)?  $default,) {final _that = this;
switch (_that) {
case _StatusModel() when $default != null:
return $default(_that.id,_that.diperbaruiPada);case _:
  return null;
...
class _StatusModel extends StatusModel {
  const _StatusModel({this.id = globalStatusId, this.diperbaruiPada}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _StatusModel&&(identical(other.id, id) || other.id == id)&&(identical(other.diperbaruiPada, diperbaruiPada) || other.diperbaruiPada == diperbaruiPada));
}
...
/// Create a copy of StatusModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? diperbaruiPada = freezed,}) {
