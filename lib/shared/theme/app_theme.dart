...
class AppTheme {
  ...
  static final TextTheme _appTextTheme = TextTheme(
    ...
    displayMedium: GoogleFonts.poppins(fontSize: 45, fontWeight: FontWeight.w500),
    displaySmall: GoogleFonts.poppins(fontSize: 36, fontWeight: FontWeight.w500),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme.fromSeed(
      ...
      error: AppColors.errorColor.shade300, // diubah: Menggunakan shade yang valid
    ),
    textTheme: _appTextTheme,
    appBarTheme: AppBarTheme(
