// path: lib/shared/operasi/category_repository.dart
...
class KategoriOperasi {
  ...
  /// Instance dari OperasiDasar untuk operasi database umum.
  final OperasiDasar operasiDasar;

  /// Konstruktor untuk KategoriOperasi.
  KategoriOperasi(
  ...
  Future<KategoriModel> createKategori(
    ...
    try {
      ...
      await operasiDasar.sisipkan('kategori', data, dariServer: dariServer);
  ...
  Future<void> update(final KategoriModel kategori,
  ...
  Future<void> delete(final String id, {final bool dariServer = false}) async {
    ...
    try {
      await operasiDasar.hapus('kategori', id, dariServer: dariServer);
  ...
  Future<void> bersihkanDanSisipkanSemua(
    ...
    try {
      await operasiDasar.jalankanOperasiKompleks<void>(
        (final txn) async {
